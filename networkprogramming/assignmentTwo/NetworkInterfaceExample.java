    ...
    public static void main(String[] args) {
        try {
            ...
            while (card.hasMoreElements()) {
                ...
                // hardware address
                byte [] macByte  = cardReader.getHardwareAddress();
                System.out.println("mac address: " + Arrays.toString(macByte));
                ...
                for (InterfaceAddress ia : cardAddress) {
                    ...
                    System.out.println("ipV6 host address: " + ia.getAddress().getHostAddress());
                    // subnet mask
