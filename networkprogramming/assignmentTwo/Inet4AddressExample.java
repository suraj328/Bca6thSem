...
public class Inet4AddressExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            // it creates inetv4address instance to store local host ip it teakes your local
            // machine ip as paramaeter
            ...
            System.out.println("isSiteLocalAdress " + localAddress.isSiteLocalAddress());
            ...
            // cretaing instance of Internet4address to strore ipv4 address and host name of
            // facebook;
            ...
            System.out.println("isSiteLocalAdress remote " + remoteAddress.isSiteLocalAddress());
            ...
            // getAllByName
            InetAddress [] addreses = InetAddress.getAllByName("www.google.com");
            for (InetAddress inetAddress : addreses) {
                System.err.println("-------");
